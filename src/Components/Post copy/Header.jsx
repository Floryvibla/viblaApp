...
const Header = ({ imageProfile,  username, localisation, relative }) => {
  ...
  return (
    <Area relative={relative}>
        <AreaPerfil>
            ...
            />
             <AreaUsername>
                <Text style={{fontWeight: 'bold'}}> {username ?? "unamed"} </Text>
                <Text size={10} color={colors.white} > {localisation ?? "Wakanda forever"} </Text>
            </AreaUsername>
        </AreaPerfil>
        <AreaFollow>
