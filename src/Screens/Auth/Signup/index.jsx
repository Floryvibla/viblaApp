...
export const Signup = () => {
  ...
  const handleSubmit = () => {
    dispatch(othersActions.openModal("notification welcome"))
  }
  ...
  return (
    ...
    >
      ...
      <Wrapper marginBottom={10}>
        <Text size={26} weight={600}> {dataLanguage.msg_signup} </Text>
      </Wrapper>
      <Wrapper>
        <TextInput 
      ...
      <Wrapper>
        <Button onPress={handleSubmit}>
          <ButtonLinearGradient>
            <Text size={16} weight={"bold"}>{dataLanguage.continue}</Text>
          </ButtonLinearGradient>
        </Button>
      </Wrapper>
    </AreaFormKeyBoard>
